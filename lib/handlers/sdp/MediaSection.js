...
class MediaSection
{
	 ...
	 */
	setIceParameters(setIceParameters)
	{
		logger.debug('MediaSection setIceParameters, [setIceParameters:%o]', setIceParameters);
...
class AnswerMediaSection extends MediaSection
{
	...
	setDtlsRole(role)
	{
		...
		logger.debug('AnswerMediaSection, setDtlsRole, [role:%o, this._mediaObject.setup:%o]', role, sthis._mediaObject.setup);
	}
}
