...
class Chrome70
{
	static async getNativeRtpCapabilities()
	{
		...
		logger.debug('Chrome70, getNativeRtpCapabilities(), [iceServers:%o, iceTransportPolicy:%o, '+
			'bundlePolicy:%o, rtcpMuxPolicy:%o, sdpSemantics:%o]',
			iceServers, iceTransportPolicy, bundlePolicy, rtcpMuxPolicy, sdpSemantics);
		try
		{
